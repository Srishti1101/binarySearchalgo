export default function SketchGraphs(p)
{
    ...
    function notifyToUser()
    {
        ...
        {
            case "vertex":
                p.text("-Click on an empty place to add a vertex.\n-Press on a vertex to delete it.", x, y);
                break;

            case "edgeFirst":
                p.text("-Select a first vertex to create or delete an edge.\n-Select an edge value to change it.", x, y);
                break;

            case "edgeSecond":
                p.text("-Select a second vertex to create or delete an edge.", x, y);
                break;
            ...
            case "changingValue":
                ...
                p.fill("white")
                p.stroke("black");
                p.text(`-Vertex ${mode.startID} ➡ vertex ${mode.destinyID}, enter a new positive value:`, x, y);
